...
func (ReturnValue) Descriptor() protoreflect.EnumDescriptor {
	return file_hsm_hsm_proto_enumTypes[1].Descriptor()
}

func (ReturnValue) Type() protoreflect.EnumType {
	return &file_hsm_hsm_proto_enumTypes[1]
}
...
type SessionInfo struct {
	...
	SlotId        uint64       `protobuf:"varint,1,opt,name=slotId,proto3" json:"slotId,omitempty"`
	State         SessionState `protobuf:"varint,2,opt,name=state,proto3,enum=hsm.SessionState" json:"state,omitempty"`
...
var file_hsm_hsm_proto_rawDesc = []byte{
	...
	0x2f, 0x68, 0x73, 0x6d, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
